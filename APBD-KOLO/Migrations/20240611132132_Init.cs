    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_Pastry", x => new { x.CharacterId, x.TitleId });
                    table.ForeignKey(
                        name: "FK_Order_Pastry_characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_Pastry_titles_TitleId",
                        column: x => x.TitleId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 50, "Krzysztow", "Gargulec", 100 },
                    { 2, 60, "Adam", "Kulogniot", 100 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "KrzysioweZakola", 50 },
                    { 2, "KrzysioweOkulary", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, new DateTime(2024, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
